...
Route::get('/projecttasks/{title}', 'ProjectCoreController@gettasks');
Route::get('/customer/{title}', 'ProjectCoreController@customer');
Route::get('/projects', 'ProjectCoreController@projects');
